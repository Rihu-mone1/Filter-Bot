...
PM_START_TEXT = """
*Hello* *{}*
🤤🤣 LMAO bruh do not waste time looking to add me to your group, btw  🌝 pls join  @Seriesland4U_Netflix_HBO!!
...
if START_IMG is None:
    img = "https://telegra.ph/file/6de4c99f5a349d64a1102.jpg"
else:
  img = START_IMG    
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="⚙️Help",callback_data="help_back"),InlineKeyboardButton(text="Master🤤",url="https://t.me/Rihu_mone")]]
...
def help_button(bot: Bot, update: Update):
    ...
    next_match = re.match(r"help_next\((.+?)\)", up.data)
...
def get_help(bot: Bot, update: Update):
    ...
    if chat.type != chat.PRIVATE:
        ...
        update.effective_message.reply_text("Contact me in PM to get the list of possible commands.",
                                            reply_markup=InlineKeyboardMarkup(
                                                [[InlineKeyboardButton(text="⚙️Help",url="t.me/{}?start=help".format(bot.username))],  
                                                [InlineKeyboardButton(text="😙Contact Creator",url="https://t.me/Rihu_mone")]]))
        return
...
def source(bot: Bot, update: Update):
    ...
    if chat.type == "private":
        ...
        try:
            ...
            update.effective_message.reply_text("Contact me in PM first to help.")
